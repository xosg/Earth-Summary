import { Image, MatchRequest, MatchResult, Region } from "@nut-tree-fork/shared";
/**
...
export interface ImageFinderInterface {
     ...
     */
    findMatch<PROVIDER_DATA_TYPE>(matchRequest: MatchRequest<Image, PROVIDER_DATA_TYPE>): Promise<MatchResult<Region>>;
    /**
     ...
     * @memberof ImageFinderInterface
     */
    findMatches<PROVIDER_DATA_TYPE>(matchRequest: MatchRequest<Image, PROVIDER_DATA_TYPE>): Promise<MatchResult<Region>[]>;
}
